...
* env.munin_phpfpm_url: Set a custom url, defaults to _http://127.0.0.1/fpm_status_
* env.munin_phpfpm_ports: Set a custom port, defaults to _80_
* env.munin_phpbin: Set a custom php binary name, defaults to _php5-fpm_
